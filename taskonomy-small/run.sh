...
python -u  train.py --model SMTL --version v1 --gpu_id 1 > out/smtl_v1.out

# python -u  train.py --model SMTL --version v2 --gpu_id 1 > out/smtl_v2.out

python -u  train.py --model SMTL --version v3 --gpu_id 1 > out/smtl_v3.out

python -u  train.py --model SMTL_new --version v1 --gpu_id 1 > out/smtl_new_v1.out

# python -u  train.py --model SMTL_new --version v2 --gpu_id 1 > out/smtl_new_v2.out

python -u  train.py --model SMTL_new --version v3 --gpu_id 1 > out/smtl_new_v3.out