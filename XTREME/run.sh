...
python train.py --gpu_id 1 --model SMTL --version v3 --dataset udpos > out/smtl_v3_pos_all.out

python train.py --gpu_id 1 --model SMTL_new --version v1 --dataset udpos > out/smtl_new_v1_pos_all.out
...
python train.py --gpu_id 1 --model SMTL --version v1 --dataset pawsx > out/smtl_v1_pawsx_all.out

python train.py --gpu_id 1 --model SMTL --version v3 --dataset pawsx > out/smtl_v3_pawsx_all.out

python train.py --gpu_id 1 --model SMTL_new --version v1 --dataset pawsx > out/smtl_new_v1_pawsx_all.out

python train.py --gpu_id 1 --model SMTL_new --version v3 --dataset pawsx > out/smtl_new_v3_pawsx_all.out
...
python train.py --gpu_id 1 --model SMTL --version v1 --dataset panx > out/smtl_v1_panx_all.out

python train.py --gpu_id 1 --model SMTL --version v3 --dataset panx > out/smtl_v3_panx_all.out
